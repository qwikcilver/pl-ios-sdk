...
class PinePerksKYCTest: XCTestCase {
    ...
    override func setUp() {
        super.setUp()
        pinePerksKycService = PinePerksKYCService(baseUrl: "https://apiuat.pineperks.in", pinePerksUsername: "te9zvDWnZ1nMqB2KViWnbw==")
    }
    ...
    func testGivenCkycUniqueIdAndImageData_WhenDetailsArePassed_thenReturnSDKResponse() throws {
        // Arrange
        let mockKYCService = MockPinePerksKYCService(baseUrl: "https://example.com", pinePerksUsername: "testUser")
